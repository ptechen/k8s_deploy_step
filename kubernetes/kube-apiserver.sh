#!/bin/bash
etcd_server="https://192.168.3.240:2379,https://192.168.3.241:2379,https://192.168.3.242:2379"
...
cp -r /data/nfs/k8s_deploy_step/certs/pem/*.pem /opt/kubernetes/server/bin/certs
